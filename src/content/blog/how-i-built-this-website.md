---
title: 'I didn’t type the code for this website'
description: 'Six days from empty repo to the page you’re reading — built by describing what I wanted and letting AI do the typing.'
pubDate: 2026-07-21
image: '/og.jpg'
draft: true
---
...
Six days. That’s what it took to go from an empty repository to the page
you’re reading — homepage, dark mode, share cards, analytics, and now a blog.
...
demos, not the hype threads — the real thing, on a real project, with real
...
On July 14 I opened Claude Code and described a homepage the way I’d describe
it to a friend over coffee: who I am, where I’ve worked, make it fast, nothing
fancy. No wireframes. No spec. A conversation.

By the end of the day there was a React site deployed on Vercel. Was it good?
It was *fine*. It was also live, which beats good.

Then taste took over, and this is where it got interesting. The next day I
showed the AI a personal site I loved and said, in so many words, “more like
this.” Light and dark themes appeared, a yellow accent, a proper hero. A few
days later I went further and had it adopt my own design system — the Paradise
Bunker tokens I use across my projects — along with self-hosted fonts and real
copy in every section. Share cards and analytics followed, each one arriving
as a pull request for me to review.
...
After a few days a loop emerged, and it’s the part I’d bottle and sell if I
could:

1. I describe an outcome. Not code — an outcome. “I want to write content on
   my site. Advise me.”
...
put off building for years arrived in an afternoon, with the AI checking its
...
framework myself a week earlier.
...
There are example posts that lived for a day and got deleted. There’s a folder
in the repository full of abandoned share-image designs that never shipped.
The process looks clean in a blog post; the history is full of small
