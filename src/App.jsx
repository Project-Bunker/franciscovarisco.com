...
const work = [
  {
    ...
    roles: [{ title: 'Member of Technical Staff', period: 'Jan 2026 – present' }],
    blurb:
      'Building human data to power the next generation of AI models.',
  },
  {
    company: 'Askable',
    ...
    blurb:
      'First line of code. Helped grow a user research platform from an empty repo to a company of 100+ people, and worked across every single team.',
  },
  {
    company: 'Fupay',
    logo: '/logos/fupay.png',
    roles: [{ title: 'Engineering Manager', period: 'Apr 2021 – Apr 2022' }],
    blurb:
      'Led engineering at a fintech helping Gen Z and millennials manage cash flow and buy now, pay later responsibly.',
  },
  {
    company: 'Orange Digital',
    logo: '/logos/orange-digital.png',
    href: 'https://orangedigital.co/',
    roles: [{ title: 'Software Engineer', period: 'Jan 2015 – Jan 2019' }],
    blurb:
      'Built projects for major clients and was an active member of ThinkDo, the internal incubator that hatched Askable.',
  },
  {
    company: 'Yoom',
    logo: '/logos/yoom.svg',
    ...
    blurb:
      'Digital product studio in the south of Brazil, building mobile apps and innovative software.',
  },
  {
    company: 'NL Informática',
    logo: '/logos/nl-informatica.png',
    href: 'https://nl.com.br',
    roles: [{ title: 'Software Developer', period: 'Aug 2008 – Aug 2013' }],
...
const sideProjects = [
  {
    ...
    showcase: {
      images: [
        '/showcase/paradise-1.jpg',
        '/showcase/paradise-2.jpg',
        '/showcase/paradise-3.jpg',
      ],
    },
  },
  {
    ...
    showcase: {
      instagram: 'https://www.instagram.com/dogdate.app/',
      handle: '@dogdate.app',
      images: [
        '/showcase/dogdate-1.jpg',
        '/showcase/dogdate-2.jpg',
        '/showcase/dogdate-3.jpg',
        '/showcase/dogdate-4.jpg',
      ],
    },
  },
  {
    ...
    showcase: {
      instagram: 'https://www.instagram.com/ridableau/',
      handle: '@ridableau',
      images: [
        '/showcase/ridable-1.jpg',
        '/showcase/ridable-3.jpg',
        '/showcase/ridable-2.jpg',
        '/showcase/ridable-4.jpg',
      ],
    },
  },
  {
    ...
    showcase: {
      instagram: 'https://www.instagram.com/app.glow/',
      handle: '@app.glow',
      images: [
        '/showcase/glow-1.jpg',
        '/showcase/glow-2.jpg',
...
const links = [
  {
    label: 'LinkedIn',
    text: '@xicovarisco',
    href: 'https://linkedin.com/in/xicovarisco',
    icon: 'linkedin',
  },
  {
    label: 'Instagram',
    text: '@xicovarisco',
    href: 'https://www.instagram.com/xicovarisco/',
    icon: 'instagram',
  },
  {
    label: 'X',
    text: '@franvarisco',
    href: 'https://x.com/franvarisco',
    icon: 'x',
    breakAfter: true,
  },
  {
  ...
  {
    label: 'Email',
    text: 'me@franciscovarisco.com',
    href: 'mailto:me@franciscovarisco.com',
    icon: 'email',
  },
]
...
const ICONS = {
  ...
  x: {
    viewBox: '0 0 24 24',
    d: 'M18.24 2.25h3.31l-7.23 8.26 8.5 11.24h-6.66l-5.21-6.82L5 21.75H1.68l7.73-8.84L1.25 2.25h6.83l4.71 6.23 5.45-6.23zm-1.16 17.52h1.83L7.08 4.13H5.12l11.96 15.64z',
  },
  github: {
    viewBox: '0 0 16 16',
  ...
  return (
    <div className="showcase">
      <div className="showcase-grid">
        {data.images.map((src) => (
          <div key={src} className="showcase-frame">
            <img className="showcase-img" src={src} alt="" loading="lazy" />
          </div>
        ))}
      </div>
      {data.instagram && (
        <a
          className="showcase-ig"
          href={data.instagram}
          target="_blank"
          rel="noreferrer"
        >
      ...
      {items.map((x) => (
        <li className="xp" key={x.company}>
          ...
          <div className="xp-body">
            ...
            {x.showcase && <Showcase data={x.showcase} />}
          </div>
        </li>
      ))}
    </ol>
      ...
      <main id="top">
        ...
        <section className="hero">
          ...
          <p className="hero-sub">
            Brazilian <span className="flag">🇧🇷</span> by birth, Australian{' '}
            <span className="flag">🇦🇺</span> by choice. I love bringing
            ambitious ideas to life: experimenting, building quickly and
            learning by doing (and by making mistakes). Today that means one of
            the hardest problems in AI, capturing what real experts actually do
            so models train on genuine human signal.
          </p>
          <p className="hero-sub">
            The best things I’ve built came from curious, passionate people 🤌.
            This site is my corner of the internet: work, opinions and the
            things I care about, with no algorithm deciding what you see.
          </p>
        </section>
        ...
        <Section
          ...
          description="Life is a collection of moments that happen beyond a screen. Experiences shape who we are and take us to places we never dreamed of. Here are some of mine."
        >
            ...
            {links.map((l, i) => [
              <li key={l.label}>
                ...
                >
                  <svg
                    className="hi-icon"
                    viewBox={ICONS[l.icon].viewBox}
                    aria-hidden="true"
                  >
                    <path d={ICONS[l.icon].d} fill="currentColor" />
                  </svg>
                  {l.text}
                </a>
              ...
              l.breakAfter && (
                <li key={`${l.label}-break`} className="hi-break" aria-hidden />
              ),
            ])}
          </ul>
        </Section>
